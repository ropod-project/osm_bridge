...
class Corridor(WMEntity):

    def __init__(self, corridor_id, *args, **kwargs):      
        __,__,relations = self.osm_adapter.get_osm_element_by_id(ids=[corridor_id], data_type='relation')
        ...
        if len(relations) == 1:
            ...
            self.logger.error("No corridor found with given id {}".format(corridor_id))  
