...
class Door(WMEntity):
    ...
    def __init__(self, door_ref, *args, **kwargs):
        ...
        if len(relations) == 1:
            ...
            self.logger.error(
                "No door found with given ref {}".format(door_ref))
